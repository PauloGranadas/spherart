...
<form method="POST" action="/users">
    ...
    <div class="col">
        <div class="form-outline">
            <input type="text" id="form3Example2" class="form-control" name="nickname" value="{{old('nickname')}}" />/> />
            <label class="form-label" for="form3Example2">Nickname</label>
            @error('nickname')
            <p class="text-red-500 text-xs mt-1">{{$message}}</p>
            @enderror
        </div>
    ...
    <div class="col">
        <div class="form-outline">
            <input type="text" id="form3Example2" class="form-control" name="country" value="{{old('country')}}" />/>/>
